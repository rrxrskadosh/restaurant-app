...
//Imported Methods Firebase Storage
...
const CreateContainer = () => {
    ...
    return(
        <div className="w-full min-h-screen flex items-center justify-center">
            <div className="w-[90%] md:w-[75%] border boder-gray-300 rounded-lg p- 
                ...
                <div className="w-full">
                    ...
                    border-gray-200 p-2 rounded-md cursor-pointer">
                        ...
                        {  categories && 
                            categories.map((item) => (
                            <option 
                                key={item.id} className="text-base border-0 outline-none 
                       ...
                       <> 
                        ...
                        <>
                            <div className="relative h-full">
                                ...
                                <button
                                    type="button"
                                    className="absolute bottom-3 rigth-3 p-3 rounded-full
